...
@app.post(
    "/sync/backend-core",
    tags=["Sync"],
    summary="Sync backend-core into MySQL — scheduled daily 02:00 Europe/Amsterdam",
    description=(
...
@app.post(
    "/sync/translations",
    tags=["Sync"],
    summary="Sync KO metadata translations into MySQL — scheduled daily 04:00 Europe/Amsterdam",
    description=(
...
@app.post(
    "/pipeline/fast",
    tags=["Pipeline"],
    summary="Run fast MySQL-backed pipeline — scheduled daily 05:30 Europe/Amsterdam",
    description=(
...
@app.post(
    "/pipeline/deferred",
    tags=["Pipeline"],
    summary="Run deferred MySQL-backed pipeline — scheduled Fridays 22:00 Europe/Amsterdam",
    description=(
...
@app.post(
    ...
    tags=["Exports"],
    summary="Export final-improved snapshot from MySQL — scheduled daily 08:00 Europe/Amsterdam",
    description=(
...
@app.post(
    "/projects/export",
    tags=["Exports"],
    summary="Export backend-core projects snapshot — scheduled daily 12:00 Europe/Amsterdam",
    description=(
