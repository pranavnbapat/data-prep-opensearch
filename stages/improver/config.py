...
METADATA_MAX_ATTEMPTS = int(os.getenv("IMPROVER_METADATA_MAX_ATTEMPTS", "3"))
METADATA_INPUT_MAX_CHARS = int(os.getenv("IMPROVER_METADATA_INPUT_MAX_CHARS", "12000"))
METADATA_EXISTING_VALUE_MAX_CHARS = int(os.getenv("IMPROVER_METADATA_EXISTING_VALUE_MAX_CHARS", "4000"))
